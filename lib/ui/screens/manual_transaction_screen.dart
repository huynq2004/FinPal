...
class _ManualTransactionFormState extends State<_ManualTransactionForm> {
	...
	final List<String> _categories = [
		'Ăn uống', 'Mua sắm', 'Di chuyển', 'Hóa đơn', 'Giải trí', 'Lương', 'Khác'
	];
	final List<String> _sources = [
		'Vietcombank', 'Techcombank', 'ACB', 'VPBank', 'MB Bank', 'Tiền mặt'
	];
	...
	Future<void> _pickTime(BuildContext context, ManualTransactionViewModel viewModel) async {
			...
			builder: (context, viewModel, _) {
				return Scaffold(
					...
					appBar: AppBar(
						...
						elevation: 0,
						title: const Text('Thêm giao dịch', style: TextStyle(color: Color(0xFF0F172A), fontSize: 16, fontFamily: 'Arimo', fontWeight: FontWeight.w400)),
						centerTitle: false,
						actions: [IconButton(icon: const Icon(Icons.close, color: Color(0xFF64748B)), onPressed: () => Navigator.of(context).pop())],
					),
							...
							child: Form(
								...
								child: Column(
									...
									children: [
										...
										Text('Số tiền', style: TextStyle(color: Color(0xFF64748B), fontSize: 14, fontFamily: 'Arimo', fontWeight: FontWeight.w400)),
										const SizedBox(height: 8),
										TextFormField(
																						...
																						child: GestureDetector(
																							...
																							child: Container(
																								...
																								decoration: BoxDecoration(
																									color: viewModel.type == 'Chi tiêu' ? Colors.white : Colors.transparent,
																								...
																								child: Text('Chi tiêu', style: TextStyle(color: viewModel.type == 'Chi tiêu' ? Color(0xFF0F172A) : Color(0xFF64748B), fontSize: 16, fontFamily: 'Arimo', fontWeight: FontWeight.w400)),
																							),
																						),
																					),
																					Expanded(
																						child: GestureDetector(
																							...
																							child: Container(
																								height: 48,
																								decoration: BoxDecoration(
																									color: viewModel.type == 'Thu nhập' ? Colors.white : Colors.transparent,
																									borderRadius: BorderRadius.circular(10),
																								...
																								alignment: Alignment.center,
																								child: Text('Thu nhập', style: TextStyle(color: viewModel.type == 'Thu nhập' ? Color(0xFF0F172A) : Color(0xFF64748B), fontSize: 16, fontFamily: 'Arimo', fontWeight: FontWeight.w400)),
																							),
																						),
																					),
																				],
								...
								const SizedBox(height: 8),
																		DropdownButtonFormField<String>(
																			...
																			items: _sources.map((s) => DropdownMenuItem(value: s, child: Text(s, style: TextStyle(color: Color(0xFF0F172A), fontSize: 16, fontFamily: 'Arimo', fontWeight: FontWeight.w400)))).toList(),
																			onChanged: (v) => viewModel.setSource(v ?? viewModel.source),
																			decoration: InputDecoration(
																				filled: true,
																				fillColor: Colors.white,
																				border: OutlineInputBorder(
									...
									children: [
										Expanded(
											child: Column(
												crossAxisAlignment: CrossAxisAlignment.start,
												children: [
													Text('Ngày', style: TextStyle(color: Color(0xFF64748B), fontSize: 14, fontFamily: 'Arimo', fontWeight: FontWeight.w400)),
													const SizedBox(height: 8),
																							InkWell(
																								...
																								child: InputDecorator(
																									...
																									child: Row(
																										children: [
																											...
																											Text('${viewModel.date.day}/${viewModel.date.month}/${viewModel.date.year}', style: TextStyle(color: Color(0xFF0F172A), fontSize: 16)),
																										],
																									),
																								),
																							),
										...
										Expanded(
											child: Column(
												crossAxisAlignment: CrossAxisAlignment.start,
												children: [
													Text('Giờ', style: TextStyle(color: Color(0xFF64748B), fontSize: 14, fontFamily: 'Arimo', fontWeight: FontWeight.w400)),
													const SizedBox(height: 8),
																							InkWell(
																								...
																								child: InputDecorator(
																									...
																									child: Row(
																										children: [
																											Icon(Icons.access_time, size: 18, color: Color(0xFF64748B)),
																											const SizedBox(width: 8),
																											Text(viewModel.time.format(context), style: TextStyle(color: Color(0xFF0F172A), fontSize: 16)),
																										],
																									),
																								),
																							),
								...
								const SizedBox(height: 16),
								Text('Nội dung / Mô tả', style: TextStyle(color: Color(0xFF64748B), fontSize: 14, fontFamily: 'Arimo', fontWeight: FontWeight.w400)),
								const SizedBox(height: 8),
																		TextFormField(
																				...
																				Expanded(
																					child: ElevatedButton(
																						style: ElevatedButton.styleFrom(
																							...
																							textStyle: const TextStyle(fontSize: 16, fontFamily: 'Arimo', fontWeight: FontWeight.w400),
																						),
																						onPressed: () async {
																				...
																				Expanded(
																					child: OutlinedButton(
																						style: OutlinedButton.styleFrom(
																							padding: const EdgeInsets.symmetric(vertical: 16),
																							shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
																							side: const BorderSide(color: Color(0xFFF2F4F6), width: 0.67),
